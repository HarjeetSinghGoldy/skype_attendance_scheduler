...
export declare type TypeName<T = any> = string;
...
export interface VersionedType<T, Input, Output extends Input, Diff> extends Type<T>, JsonSerializer<T, Input, Output> {
    /**
